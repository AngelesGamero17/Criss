...
<li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link active" href="{{route('Detalleventas.index')}}">Detalle Ventas</a>
      </li>
      ...
      <br>
                  <div class="container"  style="background-color:#FCDBDA;">
                    <table class="table table-danger table-hover">
                        <thead class="bg-danger text-white">
                          <br>
                        <h1>Pestaña de Detalleventas</h1>
                        <br>
                            <thead>
                                <th>Fecha</th>
                                <th>Costo Final</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$detalleventa->costofinal}}</td>
                                        <td>{{$detalleventa->nombre}}</td>
                                        <td>{{$detalleventa->cantidad}}</td>
                                        <td>{{$detalleventa->costoProducto}}</td>
                                        <td>{{$detalleventa->id_productos}}</td>
                                        <td>{{$detalleventa->id_clientes}}</td>
                                        <td>
                                            
                                        <nav class="navbar navbar-light bg-light">
                                        <a class="navbar-brand" href="{{route('Detalleventas.edit',$detalleventa->id)}}"> <center><b>Editar</b>
           ...
           <div class="col-md-4 offset-md-4">
            <div class="d-grid mx-auto">
                ...
                <a class="navbar-brand" href="{{route('Detalleventas.create')}}"> <b>Crear</b>  
                </a>
