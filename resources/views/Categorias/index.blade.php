...
<li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link active" aria-current="true" href="{{route('Categorias.index')}}">Categorias</a>
      </li>
      <li class="nav-item">
      ...
      <br>
                            ...
                            <thead>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <a class="navbar-brand" href="{{route('Categorias.edit',$categoria->id)}}"> <center><b>Editar</b>
           ...
           <div class="col-md-4 offset-md-4">
            <div class="d-grid mx-auto">
                ...
                <a class="navbar-brand" href="{{route('Categorias.create')}}"> <b>Crear</b>  
                </a>
