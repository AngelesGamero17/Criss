                            ...
                            <thead>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$producto->id_descuentos}}</td>
                                        <td>

                                        <nav class="navbar navbar-light bg-light">
                                        <a class="navbar-brand" href="{{route('Productos.edit',$producto->id)}}"> <center><b>Editar</b>
                                 ...
                                 <div class="row mt-3">
                                    <div class="col-md-4 offset-md-4">
                                        <div class="d-grid mx-auto">
                                            ...
                                            <a class="navbar-brand" href="{{route('Productos.create')}}"> <b>Crear</b>  
                                            </a>
