...
<li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link active" href="{{route('Descuentos.index')}}">Descuentos</a>
      </li>
      <li class="nav-item">
      ...
      <br>
                            ...
                            <thead>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <a class="navbar-brand" href="{{route('Descuentos.edit',$descuento->id)}}"> <center><b>Editar</b>
           ...
           <div class="col-md-4 offset-md-4">
            <div class="d-grid mx-auto">
                ...
                <a class="navbar-brand" href="{{route('Descuentos.create')}}"> <b>Crear</b>  
                </a>
